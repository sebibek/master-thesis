...
public:
	propagator(const int dim, double* mean, std::vector<thrust::host_vector<double>>* sampleBuffA, std::vector<thrust::host_vector<double>>* sampleBuffB, std::vector<thrust::host_vector<double>>* ellipseArray)
	{
		...
		read = thrust::host_vector<double>(steps, 0.0);
		glyph = thrust::host_vector<double>(steps, 0.0);
...
int main(int argc, char* argv[])
{
	...
	std::vector<thrust::host_vector<double>> sampleBufferA(dim, initArray);
	std::vector<thrust::host_vector<double>> sampleBufferB(dim, initArray);
	std::vector<thrust::host_vector<double>> sampleBufferInit(dim, initArray);
