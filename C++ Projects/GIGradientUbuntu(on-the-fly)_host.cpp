...
void saxpy_fast(double a, thrust::host_vector<double>& X, thrust::host_vector<double>& Y) // TODO: try changing 2nd Y.begin() to Z.begin, Y to thrust::host_vector<double> Y and UNCOMMENT
{
