...
class propagator
{
	...
	std::vector<std::vector<double>> sampleBufferInit;
...
public:
	propagator(const int dim, double* mean, std::vector<std::vector<double>>* sampleBuffA, std::vector<std::vector<double>>* sampleBuffB, std::vector<std::vector<double>>* ellipseArray)
	{
		...
		sampleBufferInit = std::vector<std::vector<double>>(dim, std::vector<double>(steps, 0.0));
...
int main(int argc, char* argv[])
{
	...
	std::vector<std::vector<double>> sampleBufferLeft(dim, std::vector<double>(steps, 0.0));
	std::vector<std::vector<double>> sampleBufferRight(dim, std::vector<double>(steps, 0.0));
