	...
	void propagate()
	{
		...
		for(int j = 1; j < width -1; j++)
			for (int i = 1; i < width-1; i++) // for each node..
			{
				...
				meanA += thrust::reduce(outVector[0].begin(), outVector[0].end()) + thrust::reduce(outVector[1].begin(), outVector[1].end())*radres + thrust::reduce(outVector[2].begin(), outVector[2].end()) + thrust::reduce(outVector[3].begin(), outVector[3].end()) + thrust::reduce(outVector[4].begin(), outVector[4].end()) + thrust::reduce(outVector[5].begin(), outVector[5].end()) + thrust::reduce(outVector[6].begin(), outVector[6].end()) + thrust::reduce(outVector[7].begin(), outVector[7].end());
