...
// zip8Iterator
typedef thrust::tuple<int, DoubleIterator, thrust::host::vector<Double8Iterator>,DoubleIterator, double, Double8Iterator, Double8Iterator, Double8Iterator> zip8Tuple; // --> 1 single element of zip iterator for DEREFERENCE!, defines casting behaviour

typedef thrust::tuple<thrust::counting_iterator<int>, thrust::constant_iterator<DoubleIterator>, thrust::constant_iterator<thrust::host::vector<Double8Iterator>>,thrust::constant_iterator<DoubleIterator>, DoubleIterator, thrust::constant_iterator<Double8Iterator>,thrust::constant_iterator<Double8Iterator>,thrust::constant_iterator<Double8Iterator>> zip8IteratorTuple; // -->8 dbl iterators
typedef thrust::zip_iterator<zip8IteratorTuple> zip8Iterator;


// ConstDouble8IteratorTuple
typedef thrust::tuple<thrust::constant_iterator<DoubleIterator>, thrust::constant_iterator<DoubleIterator>, thrust::constant_iterator<DoubleIterator>, thrust::constant_iterator<DoubleIterator>, thrust::constant_iterator<DoubleIterator>, thrust::constant_iterator<DoubleIterator>, thrust::constant_iterator<DoubleIterator>, thrust::constant_iterator<DoubleIterator>> ConstDouble8IteratorTuple; // -->8 dbl iterators

typedef thrust::zip_iterator<ConstDouble8IteratorTuple> ConstDouble8Iterator;

// ConstDouble16IteratorTuple
//typedef thrust::tuple<DoubleIterator, DoubleIterator, DoubleIterator, DoubleIterator, DoubleIterator, DoubleIterator, DoubleIterator, DoubleIterator, DoubleIterator, DoubleIterator, DoubleIterator, DoubleIterator, DoubleIterator, DoubleIterator, DoubleIterator, DoubleIterator>> Double16IteratorTuple; // -->8 dbl iterators
typedef thrust::tuple<thrust::constant_iterator<DoubleIterator>, thrust::constant_iterator<DoubleIterator>, thrust::constant_iterator<DoubleIterator>, thrust::constant_iterator<DoubleIterator>, thrust::constant_iterator<DoubleIterator>, thrust::constant_iterator<DoubleIterator>, thrust::constant_iterator<DoubleIterator>, thrust::constant_iterator<DoubleIterator>, thrust::constant_iterator<DoubleIterator>, thrust::constant_iterator<DoubleIterator>, thrust::constant_iterator<DoubleIterator>, thrust::constant_iterator<DoubleIterator>, thrust::constant_iterator<DoubleIterator>, thrust::constant_iterator<DoubleIterator>, thrust::constant_iterator<DoubleIterator>, thrust::constant_iterator<DoubleIterator>> ConstDouble16IteratorTuple; // -->8 dbl iterators

typedef thrust::zip_iterator<ConstDouble16IteratorTuple> ConstDouble16Iterator;


struct reduceFunctor : public thrust::unary_function<ConstDouble16IteratorTuple, double>
{
	double radres;
	reduceFunctor(double _radres)
	{
		radres = _radres;
	}
    __host__ //__device__
...
public:
    propagateCell(int _width, int _steps, double _radres, double* mean, Double8Iterator& _firstWeights, Double8Iterator& _firstCosine, Double8Iterator& _lastCosine)
    {
		width = _width;
		steps = _steps;
		radres = _radres;
		...
		firstOutT = thrust::make_zip_iterator(thrust::make_tuple(outVector[0].begin(), outVector[0].end(), outVector[1].begin(), outVector[1].end(), outVector[2].begin(), outVector[2].end(), outVector[3].begin(), outVector[3].end(), outVector[4].begin(), outVector[4].end(), outVector[5].begin(), outVector[5].end(), outVector[6].begin(), outVector[6].end(), outVector[7].begin(), outVector[7].end());
		//lastOutT = thrust::make_zip_iterator(thrust::make_tuple(outVector[0].end(), outVector[1].end(), outVector[2].end(), outVector[3].end(), outVector[4].end(), outVector[5].end(), outVector[6].end(), outVector[7].end())); //= thrust::get<9>(t);
		...
		sumIter = thrust::make_zip_iterator(thrust::make_tuple(thrust::make_constant_iterator(sums.begin()), thrust::make_constant_iterator(sums.begin() + 1), thrust::make_constant_iterator(sums.begin() + 2), thrust::make_constant_iterator(sums.begin() + 3), thrust::make_constant_iterator(sums.begin() + 4), thrust::make_constant_iterator(sums.begin() + 5), sums.begin() + 6, thrust::make_constant_iterator(sums.begin() + 7))));
    }

   // template <typename Tuple>
    __host__ //__device__ 
   
    void operator()(const zip8Tuple& t)
    {

    	int index = thrust::get<0>(t);
    	
    	if (index == 0 || index % width == 0 || index / width == height - 1 || index % width == width-1)
    		return;
       ...
       // thrust::get<3>(t) = thrust::get<0>(t) + thrust::get<1>(t) * thrust::get<2>(t);
		...
		thrust::advance(end, (index+1) * steps);
		...
		thrust::advance(readGlyphEnd, (index+1) * steps);
		...
		thrust::transform(firstOutT, firstOutT+1, sumIter, reduceFunctor(radres));
		...
		*meanA += thrust::reduce(sums.begin(), sums.end(), 0.0); // sum up sums to obtain mean energy for convergence criterion
		...
		firstDst = thrust::get<2>(t); // TODO: prepare firstDst as host::vector for every cell index, ALSO prepare start,end, readGlyph
...
class propagator
{
	...
	thrust::host::vector<Double8Iterator> cellDestinations;

	zip8Iterator zipFirst;
	zip8Iterator zipLast;
...
public:
	...
	propagator(const int dim, thrust::host_vector<double>* ellipseArray)
	{
		...
		cellDestinations = thrust::host::vector<Double8Iterator>(dim);
		...
		zipFirst = thrust::make_zip_iterator(thrust::make_tuple(itFirst, thrust::make_constant_iterator(sampleBufferA.begin()), thrust::make_constant_iterator(cellDestinations), thrust::make_constant_iterator(readGlyph.begin()), tMeans.begin(), thrust::make_constant_iterator(firstWeights), thrust::make_constant_iterator(firstCosine), thrust::make_constant_iterator(lastCosine)));
		zipLast = thrust::make_zip_iterator(thrust::make_tuple(itLast, thrust::make_constant_iterator(sampleBufferA.begin()), thrust::make_constant_iterator(cellDestinations), thrust::make_constant_iterator(readGlyph.begin()), tMeans.end(), thrust::make_constant_iterator(firstWeights), thrust::make_constant_iterator(firstCosine), thrust::make_constant_iterator(lastCosine)));
	...
	void propagate()
	{
		...
		// 1 propagation cycle
		thrust::for_each(zipFirst, zipLast, propagateCell(width,steps,radres, &meanA, firstWeights, firstCosine, lastCosine));
		cout << "passed foreach.. ";
