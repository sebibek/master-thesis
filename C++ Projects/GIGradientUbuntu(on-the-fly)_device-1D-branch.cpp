...
public:
	...
	void propagate()
	{
		thrust::transform(sampleBufferA.begin(), sampleBufferA.end(), glyphBuffer.begin(), readGlyph.begin(), std::multiplies<double>()); // perform read*glyph element-wise via trust transform method
