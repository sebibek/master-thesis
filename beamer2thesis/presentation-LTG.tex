...
\centering
 ...
 \begin{minipage}{0.2\textwidth}
  ...
  \begin{minipage}{0.2\textwidth}
    \centering
    \includegraphics[height=0.8\textwidth]{iso_left.png}
    \label{a)}
  \end{minipage} $-$
  \begin{minipage}{0.2\textwidth}
    \centering
    \includegraphics[height=0.8\textwidth]{iso_right.png}
    \label{b)}
  \end{minipage} $=$
   \begin{minipage}{0.2\textwidth}
    \centering
    \includegraphics[height=0.8\textwidth]{iso_diff.png}
    \label{b)}
  \end{minipage}
\label{analysis1}
\end{figure}
...
\centering
 ...
 \begin{minipage}{0.2\textwidth}
  ...
  \begin{minipage}{0.2\textwidth}
    \centering
    \includegraphics[height=0.8\textwidth]{iso_leftangle.png}
    \label{a)}
  \end{minipage} $-$
  \begin{minipage}{0.2\textwidth}
    \centering
    \includegraphics[height=0.8\textwidth]{iso_rightangle.png}
    \label{b)}
	\end{minipage} $=$
   \begin{minipage}{0.2\textwidth}
    \centering
    \includegraphics[height=0.8\textwidth]{iso_anglediff.png}
    \label{b)}
  \end{minipage}
