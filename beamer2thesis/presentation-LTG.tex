...
\centering
\begin{figure}
\caption*{\textit{Vector fields}}\bigskip
...
\begin{figure}
\caption*{\textit{Streamlines for vector fields}}\bigskip
\begin{minipage}{.49\textwidth}
\centering
...
\begin{align*}
	\Phi_{t} &= n_f\varepsilon_k\int T(\omega)I(\omega)\mathop{d\omega}\hskip 15pt \mathit{with} \mean{T}\overset{!}{=}\\
...
\begin{minipage}{.49\textwidth}
\centering
\includegraphics[height=\textwidth]{iso_volume.png} \caption*{a)~Glyphs}
\end{minipage}
\begin{minipage}{.49\textwidth}
\centering
\includegraphics[height=\textwidth]{iso_isovolume.png} \caption*{b)~LTG volume}
\end{minipage}
...
\caption*{\textit{Brain test field (denoised)}}\bigskip
  \begin{minipage}[t]{0.3\textwidth}
   \centering
  \includegraphics[height=0.7\textwidth]{img/brain_denoised.png}
	{\scriptsize a)~Glyphs}
    \label{a)}
  \end{minipage}
  \begin{minipage}[t]{0.3\textwidth}
...
\begin{minipage}{0.21\textwidth}
  \centering
    \includegraphics[height=\textwidth]{img/brain_denoised.PNG}\\{\scriptsize a)~Glyphs}
    \label{b)}
  \end{minipage}\hskip 15pt
  \begin{minipage}{0.21\textwidth}
  \centering
  \includegraphics[height=\textwidth]{brain_surf.PNG} {\scriptsize b) LTG($0^\circ$) }
     \label{a)}
  \end{minipage}\hskip 15pt
  \begin{minipage}{0.21\textwidth}
    \centering
    \includegraphics[height=\textwidth]{brain_volume2.PNG} \\
     {\scriptsize c) LTG volume}
    \label{b)}
  \end{minipage}
  \begin{minipage}{0.21\textwidth}
    \centering
    \includegraphics[height=\textwidth]{brain_cross-section.PNG} \\
    {\scriptsize d) Cross-section}
    \label{b)}
  \end{minipage}
\label{brain-volumes}
\end{figure}
\bigskip
\begin{itemize}
	\item no anisotropy present in the Brain dataset \\$\Rightarrow$ FTLE response only in regions revealing tensor magnitudes above threshold $\theta$
\end{itemize}
} % END OF FRAME
