...
\caption*{a) $\mathop{\mathbf{u(x)}}=\begin{pmatrix}
x\\y
\end{pmatrix}$}
\end{minipage}
\begin{minipage}{.49\textwidth}
...
\caption*{b) $\mathop{\mathbf{u(x)}}=\begin{pmatrix}
-y\\x
\end{pmatrix}$}
\end{minipage}
...
\centering
\includegraphics[height=\textwidth]{random-global.png} \caption*{a) Glyphs}
\end{minipage}
\begin{minipage}{0.49\textwidth}
\centering
\includegraphics[height=\textwidth]{random-global-TFL.png} \caption*{b) Tensor field lines}
\end{minipage}
\end{figure}
