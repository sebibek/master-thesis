...
\begin{enumerate}
	\item Evaluate and accumulate the polar intensity profiles\\
	$\Phi_{t} = \int I(\omega)\mathop{d\omega}$\bigskip
...
\begin{align*}
	\Phi_{t} &= n_f\varepsilon_k\int T(\omega)I(\omega)\mathop{d\omega}\hskip 15pt \mathit{with} \ \mean{T}\overset{!}{=}1.0\\
...
\bigskip
\item evaluation of the approach proves functionality and yields promising results
\end{itemize}
%\footnotetext{Goodfellow, Ian, et al. "Generative adversarial nets."}
} % END OF FRAME
