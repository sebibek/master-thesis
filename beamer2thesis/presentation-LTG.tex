...
\centering
  ...
  \begin{minipage}{0.4\textwidth}
    \centering
    \includegraphics[height=0.9\textwidth]{iso_ftle.png}
    \label{b)}
	b)
  \end{minipage}
  \caption{Isotropic test field: a) glyphs, b) LTG($0^\circ$) for a)}
\label{ftle_iso}
\end{figure}
} % END OF FRAME
...
\centering
  \begin{minipage}{0.4\textwidth}
    \centering
    \includegraphics[height=0.9\textwidth]{iso_volume.png}
    \label{a)}
	a)
  \end{minipage}
  \begin{minipage}{0.4\textwidth}
   \centering
    \includegraphics[height=0.9\textwidth]{iso_isovolume.png}
    \label{b)}
	b)
  \end{minipage}
  \caption{Isotropic test field: a) volume, b) IsoVolume for a)}
\label{ftle_iso}
\end{figure}
} % END OF FRAME
...
\centering
  \begin{minipage}{0.3\textwidth}
	\centering
    \includegraphics[width=\textwidth]{drain(alt)-TFL.png}
    \label{a)}
	a)~TFLs and glyphs
  \end{minipage}
  \begin{minipage}{0.3\textwidth}
  \centering
    \includegraphics[width=\textwidth]{ftle_drain_alt.png}
    \label{b)}
	b)~LTG($90^\circ$) for a)
  \end{minipage}
  \begin{minipage}{0.3\textwidth}
  \centering
    \includegraphics[width=\textwidth]{drain_alt_gradient.png}
    \label{b)}
	c)~Gradient for b)
  \end{minipage}
  \caption{Drain test field}
...
\centering
  \begin{minipage}{0.3\textwidth}
    \includegraphics[height=\textwidth]{inverse_isovolume.png}
    a)
  \end{minipage}
  \begin{minipage}{0.3\textwidth}
    \includegraphics[height=\textwidth]{inverse_surface.png}
    b)
  \end{minipage}
   \begin{minipage}{0.3\textwidth}
    \includegraphics[height=\textwidth]{inverse_contour.png}
    c)
  \end{minipage}
...
\centering
  \begin{minipage}{0.3\textwidth}
  \centering
    \includegraphics[width=\textwidth]{tensorfieldlines.png}
	a) TFLs and glyphs
    \label{a)}
  \end{minipage}
  \begin{minipage}{0.3\textwidth}
  \centering
    \includegraphics[width=\textwidth]{total_anisotropy1.png}
    b) iteration $50$
    \label{b)}
  \end{minipage}
  \begin{minipage}{0.3\textwidth}
  \centering
    \includegraphics[width=\textwidth]{total_anisotropy2.png}
	c) iteration $103$
    \label{c)}
  \end{minipage}
...
\centering
  \begin{minipage}[t]{0.3\textwidth}
    \centering
  \includegraphics[height=\textwidth]{gyre.png}
	a)
    \label{a)}
  \end{minipage}
  \begin{minipage}[t]{0.3\textwidth}
    \centering
    \includegraphics[height=\textwidth]{gyre_ftle.PNG}
	b)
    \label{b)}
  \end{minipage}
  \begin{minipage}[t]{0.3\textwidth}
    \centering
    \includegraphics[height=\textwidth]{gyre_ftle_org.PNG}
	c)
    \label{b)}
  \end{minipage}
...
\centering
  \begin{minipage}{0.3\textwidth}
    \centering
  \includegraphics[height=\textwidth]{gyre_volume2.png}
	a)
    \label{a)}
  \end{minipage}
  \begin{minipage}{0.3\textwidth}
    \centering
    \includegraphics[height=\textwidth]{gyre_gauss_contour.PNG}
	b)
    \label{b)}
  \end{minipage}
   \begin{minipage}{0.3\textwidth}
     \centering
    \includegraphics[height=\textwidth]{gyre_volume4.PNG}
	c)
    \label{b)}
  \end{minipage}
...
\centering
  ...
  \begin{minipage}{0.3\textwidth}
   \centering
    \includegraphics[height=\textwidth]{brainDwnsmpl-TFL.PNG}
	b)~TFLs
    \label{b)}
  \end{minipage}
  \begin{minipage}{0.3\textwidth}
   \centering
    \includegraphics[height=\textwidth]{brain_ftle_org.PNG}
	c)~FTLE: H.'s approach
    \label{b)}
  \end{minipage}
...
\centering
  \begin{minipage}{0.3\textwidth}
   \centering
  \includegraphics[height=\textwidth]{brainDwnsmpl_denoise.png}
	a)~Glyphs
    \label{a)}
  \end{minipage}
  \begin{minipage}{0.3\textwidth}
   \centering
    \includegraphics[height=\textwidth]{brain-TFL.PNG}
	b)~TFLs
    \label{b)}
  \end{minipage}
  \begin{minipage}{0.3\textwidth}
   \centering
    \includegraphics[height=\textwidth]{brain_ftle_surf_noisereduction.PNG}
	c)~FTLE: H.'s approach
    \label{b)}
  \end{minipage}
\caption{Brain test field}
...
\centering
  ...
  \begin{minipage}{0.3\textwidth}
   \centering
    \includegraphics[width=\textwidth]{heartDwnsmpl-TFL.PNG}
	b)
    \label{b)}
  \end{minipage}
  \begin{minipage}{0.3\textwidth}
   \centering
    \includegraphics[width=\textwidth]{heart_ftle_org.PNG}
	c)
    \label{b)}
  \end{minipage}
...
\centering
  ...
  \begin{minipage}{0.3\textwidth}
   \centering
    ...
    \label{b)}
  \end{minipage}
\caption{Heart test field: a) glyphs, b) TFLs}
\label{heart-ftle-comp}
\end{figure}
...
\centering
  \begin{minipage}{0.3\textwidth}
  \centering
  \includegraphics[width=\textwidth]{heart.png}
	a)
    \label{a)}
  \end{minipage}
  \begin{minipage}{0.3\textwidth}
  \centering
    \includegraphics[width=\textwidth]{heart_slice0.PNG}
	b)
    \label{b)}
  \end{minipage}
  \begin{minipage}{0.3\textwidth}
  \centering
    ...
    \label{b)}
  \end{minipage}
  \caption{Heart test field: a) LTG global, b) LTG local, c) Hlawatsch's approach}
\label{heart-ftle}
\end{figure}
...
\centering
 \begin{minipage}{0.3\textwidth}
 \centering
 \includegraphics[height=\textwidth]{heart_volume.PNG}
   \label{a)}
 \end{minipage}\hskip 12pt
 \begin{minipage}{0.3\textwidth}
 \centering
   \includegraphics[width=\textwidth]{heart_volume3.PNG}
   \label{b)}
 \end{minipage}
 \begin{minipage}{0.3\textwidth}
 \centering
   \includegraphics[height=\textwidth]{heart_volume5.PNG}
   \label{b)}
 \end{minipage}
 \caption{Heart test field: LTG volumes}
