...
\newcommand*\mean[1]{\bar{#1}}\begin{document}
...
\end{align}.
This yields a cosine lobe, which has an overall energy of $\Phi_t$ if the point light is interpreted with a Lambert-Emitter (cf. \cite{lindlein}) characteristic (as part or area element of a diffusely reflecting surface). 
