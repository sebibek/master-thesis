...
In this chapter, we will give the prerequisites to understand the contributions of this work and we will start right away with tensors in general.\\
...
\section{Tensors}
\label{sec:tensors}
Now what is a Tensor? A tensor is a generalization of a matrix as follows:
\begin{center}
