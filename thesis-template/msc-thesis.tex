...
\begin{itemize}
	\item a light transport model (propagation scheme) following basic but crucial physical principles for tensor field visualization interpreting tensors as light transmission properties,
...
\begin{figure}[!t]
  ...
  \caption{yellow: Intensity Profile, cyan: Transmission Profile (glyph Ellipsoid Eq.)}
  \label{weighting}
\end{figure}
...
\centering
  \begin{minipage}{0.3\textwidth}
  \centering
  \includegraphics[height=\textwidth]{img_new/brain_cross-section.PNG}
    \caption*{a) tensor magnitude}
    \label{a)}
  \end{minipage}
  \begin{minipage}{0.3\textwidth}
    \centering
    \includegraphics[height=\textwidth]{img_new/brain_volume.PNG}
     \caption*{b) LTG}
    \label{b)}
  \end{minipage}
  \begin{minipage}{0.3\textwidth}
    \centering
    \includegraphics[height=\textwidth]{img_new/brain_volume2.PNG}
     \caption*{c) FTLE H.'s approach}
    \label{b)}
  \end{minipage}
...
\centering
  \begin{minipage}{0.3\textwidth}
  \centering
  \includegraphics[height=\textwidth]{img/heart.PNG}
    \caption*{a) LTG($0^\circ$): global}
    \label{a)}
  \end{minipage}
  \begin{minipage}{0.3\textwidth}
  \centering
    \includegraphics[height=\textwidth]{img_new/heart_slice0.PNG}
     \caption*{b) LTG($0^\circ$): local}
    \label{b)}
  \end{minipage}
  \begin{minipage}{0.3\textwidth}
  \centering
    \includegraphics[height=\textwidth]{img/heart_ftle_org.PNG}
...
\centering
  ...
  \begin{minipage}{0.4\textwidth}
   \centering
    ...
    \label{b)}
  \end{minipage}
\caption{\enquote{Random} test field}
\label{random}
\end{figure}
...
\centering
  ...
  \includegraphics[width=\textwidth]{img_new/random_global.png}
    \caption*{LTG: Global normalization}
    \label{a)}
  \end{minipage}
  \begin{minipage}{0.4\textwidth}
   \centering
    \includegraphics[width=\textwidth]{img_new/random_local_slice0.PNG}
     \caption*{LTG: Local normalization}
    \label{b)}
  \end{minipage}
\caption{\enquote{Random} test field}
\label{random_FTLE}
...
\hline\hline
test name - Fig. \# & resolution ($x\times y\times\omega$) & runtime $[s]$ & memory consumption (dynamic)\\
\toprule
