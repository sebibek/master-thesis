...
r_i(\omega) = 
\begin{cases}
   r_i(\omega) = r_i(\omega),& \text{if } \mean{r}_i > \theta,\\
...
\label{heart-ftle}
\end{figure}
Fig. \ref{heart-ftle} depicts the volumes for the heart test field, we can observe a 3D ridge running in spiral along the $z$-direction.
