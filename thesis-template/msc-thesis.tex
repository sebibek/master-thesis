...
develop a simple and efficient Global Illumination Scheme able to distribute energy profiles in discrete polar form in 2D/3D-space w.r.t. energy conservation and propagation attenuation principles;
able to handle any kind of matrix (symm./anti-symm.); generate transmission profiles; generate a new FTLE-related method for tensor field vis. by applying GIGradient;  be able to efficiently handle (relatively) large datasets; 
