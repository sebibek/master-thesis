...
At last, we will analyze the bow test field, which is now considered to be a bit more complicated example. We again plot the FTLE field in color coding representation in Fig. \ref{bow-ftle}.
...
\hline 
 &  &  & \\ 
\hline 
\enquote{isotropic} - \ref{bow-ftle} & $51\times51\times32=163216$ & $1357$ & $8\times163216\times 8\mathop{byte} +(51\times51 + 19\times32)\times8\mathop{byte}\approx5.998\mathop{MB}$\\ 
\hline
\enquote{rings} - \ref{bow-ftle} & $51\times51\times32=163216$ & $5761$ & $8\times163216\times 8\mathop{byte} +(51\times51 + 19\times32)\times8\mathop{byte}\approx5.998\mathop{MB}$\\ 
\hline 
\enquote{bow} - \ref{bow-ftle} & $51\times51\times32=163216$ & $6128$ & $8\times163216\times 8\mathop{byte} +(51\times51 + 19\times32)\times8\mathop{byte}\approx5.998\mathop{MB}$\\ 
\hline 
\enquote{star} - \ref{star-ftle} & $51\times51\times32=163216$ & $5815$ & $8\times163216\times 8\mathop{byte} +(51\times51 + 19\times32)\times8\mathop{byte}\approx5.998\mathop{MB}$\\ 
\hline 
...
\hline
\enquote{brain} - \ref{brain-ftle} & $128\times128\times64=1048576$ & $2427$ & $8\times166464\times 8\mathop{byte} +(128\times128 + 19\times64)\times8\mathop{byte}\approx75.5\mathop{MB}$\\
\hline
\enquote{heart} - \ref{heart-ftle} & $256\times256\times32=2097152$ & TODO & $8\times2097152\times 8\mathop{byte} +(256\times256 + 19\times64)\times8\mathop{byte}\approx151.0\mathop{MB}$\\
\hline 
\end{tabularx}
   \vskip 1pt
\end{table}
