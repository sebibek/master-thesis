...
\centering
  ...
  \end{minipage}
  \begin{minipage}{0.35\textwidth}
      \includegraphics[width=\textwidth]{img/heart_cyl_glyphs.png}
    \label{b)}
    \caption*{cyclinder glyphs}
  \end{minipage}
...
\centering
  ...
  \end{minipage}
  \begin{minipage}{0.4\textwidth}
    \includegraphics[height=\textwidth]{img/drain_ftle_org.PNG}
