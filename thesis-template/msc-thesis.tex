...
For the rest of this work, we will give a quick overview on the structure and outline. Next, in Chap.~\ref{chap:grundlagen}, we will capture important fundamentals like tensors, polar coordinates, PCA in the context of singular value decomposition (generalization of eigenvalue decomposition), FTLE and GT (ground truth) datasets. Also we will discuss the most relevant related work in the domain of tensor field visualization and also in the domain of global illumination (indirect illumination rendering). Subsequently, in Chap.~\ref{chap:main}, we will propose the main contributions and methods of this work and document the results and evaluation in Chap.~\ref{chap:eval}. At last, a compact summary, conclusion and outlook will be given in Chap.~\ref{chap:concl}.\\
...
\hskip 22pt
  \begin{minipage}[!t]{0.4\textwidth}
   ...
   \label{diverge}
   \captionsetup{font={footnotesize,bf,it}}
   \caption*{source: \url{https://shaddenlab.berkeley.edu/uploads/LCS-tutorial/dg_3traj.png}}
  \end{minipage} \hskip 40pt
  %\raggedright
  \begin{minipage}[!t]{0.4\textwidth}
...
\subsubsection{Symmteric Tensor Fields}
...
\centering
  \begin{minipage}{0.4\textwidth}
    ...
    \label{a)}
    \caption*{light source in top center}
  \end{minipage}
  \begin{minipage}{0.4\textwidth}
    \includegraphics[width=0.8\textwidth]{img/isotropic-all-center.png}
    \label{b)}
    \caption*{light source in center}
  \end{minipage}
...
\centering
  ...
  \begin{minipage}{0.4\textwidth}
    ...
    \label{b)}
    \caption*{light source in center (rescaled)}
  \end{minipage}
...
\centering
  \begin{minipage}{0.4\textwidth}
    ...
    \label{a)}
    \caption*{antisymmtric light sources}
  \end{minipage}
  \begin{minipage}{0.4\textwidth}
    \centering
    \includegraphics[width=0.9\textwidth]{img/rings-two-special2.png}
    \label{b)}
    \caption*{symmetric light sources}
  \end{minipage}
  ...
  \begin{minipage}[t]{0.4\textwidth}
   \centering
    \includegraphics[width=0.9\textwidth]{img/brain_ftle_surf_noisereduction.PNG}
     \caption*{b) H.'s app.: TFLs (noise correction)}
    \label{b)}
  \end{minipage}
\caption{\enquote{brain} test field}
...
\centering
  ...
  \centering
    ...
    \label{b)}
  \end{minipage}
  \caption{\enquote{heart} test field LTG: a) global, b) local, c) Hlawatsch's approach}
\label{heart-ftle}
\end{figure}
...
\centering
 ...
 \begin{minipage}{0.3\textwidth}
 \centering
   \includegraphics[height=\textwidth]{img_new/heart_volume3.PNG}
   \label{b)}
 \end{minipage}
 \begin{minipage}{0.3\textwidth}
 \centering
...
\hline 
\enquote{random-local} & $101\times101\times32=326432$ & $59896$ & $23.5\mathop{MB}$\\ 
\hline
\enquote{random-global} & $101\times101\times32=326432$ & $757$ & $23.5\mathop{MB}$\\ 
\hline 
