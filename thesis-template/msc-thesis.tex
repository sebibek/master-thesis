...
\label{random}
\end{figure}
In case we use local normalization, we could interpret the contributions revealing low tensor magnitudes as a result from white noise, which shows the inherent problem with local normalization. 
