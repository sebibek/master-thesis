...
\centering
  \begin{minipage}{0.4\textwidth}
  \includegraphics[width=0.9\textwidth]{img/gyre.png}
    \caption{\enquote{Gyre} test field}
    \label{a)}
  \end{minipage}
  \begin{minipage}{0.4\textwidth}
    \includegraphics[height=0.9\textwidth]{img/gyre_ftle.PNG}
...
\centering
  \begin{minipage}{0.4\textwidth}
  \includegraphics[width=0.9\textwidth]{img/brain_cyl_glyphs.PNG}
    \caption*{glyph representation}
    \label{a)}
  \end{minipage}
  \begin{minipage}{0.4\textwidth}
    \includegraphics[width=0.9\textwidth]{img/brain_ftle.PNG}
     \caption*{LTG}
    \label{b)}
  \end{minipage}
...
\centering
  \begin{minipage}{0.4\textwidth}
  \includegraphics[width=0.9\textwidth]{img/heart_org.PNG}
    \caption*{tensor magnitude}
    \label{a)}
  \end{minipage}
  \begin{minipage}{0.4\textwidth}
    \includegraphics[width=0.9\textwidth]{img/heart.PNG}
     \caption*{LTG}
    \label{b)}
  \end{minipage}
