...
\hline
\enquote{heart} - \ref{heart-ftle} & $256\times256\times32=2097152$ & TODO & $8\times2097152\times 8\mathop{byte} +(256\times256 + 19\times32)\times8\mathop{byte}\approx151.0\mathop{MB}$\\
\hline 
\end{tabularx}
   \vskip 1pt
\end{table}
