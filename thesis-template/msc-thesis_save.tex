...
\end{figure}
 ...
 particle trajectories diverging w.r.t. the central axis ending up in distance $\Delta$. The FTLE measure for this single example (point in space) is then defined as:
...
r_i(\omega) = 
\begin{cases}
   r_i(\omega) = \frac{1}{\mean{r}_i}r(\omega),& \text{if } \mean{r}_i > \theta,\\
...
\centering
  ...
  \end{minipage}
  \begin{minipage}{0.3\textwidth}
    \includegraphics[width=\textwidth]{img_new/brain_volume.PNG}
     \caption*{b) LTG}
    \label{b)}
  \end{minipage}
  \begin{minipage}{0.3\textwidth}
...
\centering
  \begin{minipage}{0.3\textwidth}
  \includegraphics[t][height=\textwidth]{img/"heart_org".PNG}
    \label{a)}
  \end{minipage}
  \begin{minipage}[t]{0.3\textwidth}
  ...
  \begin{minipage}[t]{0.3\textwidth}
    ...
    \label{b)}
  \end{minipage}
  \caption{\enquote{Brain} test field: volumes}
\label{heart-ftle}
\end{figure}
...
\begin{figure}[H]
 \begin{minipage}{0.3\textwidth}
 \includegraphics[width=\textwidth]{img_new/heart_volume.PNG}
   \caption*{a) tensor magnitude}
   \label{a)}
 \end{minipage}
 \begin{minipage}{0.3\textwidth}
 ...
 \end{minipage}
 \begin{minipage}{0.3\textwidth}
   \includegraphics[width=\textwidth]{img_new/heart_volume5.PNG}
    \caption*{c) FTLE H.'s approach}
   \label{b)}
 \end{minipage}
 \caption{\enquote{heart} test field}
\label{heart-ftle}
\end{figure}
Fig. \ref{heart-ftle} depicts the volumes for 
...
\toprule
\enquote{drain} - \ref{ftle_base} & $101\times101\times64=652864$ & $179878$ & $8\times652864\times 8\mathop{byte} +(101\times101 + 19\times64)\times8\mathop{byte}47.02\mathop{MB}$\\ 
\hline 
...
\hline 
\enquote{random} & $101\times101\times32=326432$ & $757$/$59896$ & $8\times326432\times 8\mathop{byte} +(101\times101 + 19\times32)\times8\mathop{byte}\approx23.5\mathop{MB}$\\ 
\hline 
