...
%%%%%%%% Macht Probleme: Kompilierung hï¿½ngt dann.
...
% PW: fï¿½r bbordermatrix mit eckigen Klammern
...
%%PW: l2tabu: Also \begin{center} macht in floats zusï¿½tzlichen Abstand. \Centering ist richtig!

\newcommand{\bild}[6]      % Bild-Pfadname, Beschriftung, Label, Breite, Kurzbeschriftung (fï¿½r Abbildungsverzeichnis), optional: Platzierung
{
     \begin{figure}[#6]
%      \begin{center}		%l2tabu
				\Centering
...
%So funktioniert es natï¿½rlich auch noch. Captions sind schon besser. Der Captionname ist noch zu groï¿½
\newcommand{\randbild}[5]   % Bild-Pfadname, Kurzbeschriftung (fï¿½r Abbildungsverzeichnis), Beschriftung, Breite zw. 0 und 1 = 100% des Randes, Label
{%
\marginpar%
	{%
	%%%%%\RaggedRight
	...
	justification=raggedright, indention=0.0cm}  %Variante des Caption-Pakets. Inkompatibel zu nonfloat, wo figcaption herkommt.
		%\Centering% %% sorgt dafï¿½r, dass Bild weiter links als Anfang der Caption. Mit weglassen nur noch schnlimmer
		\RaggedLeft  %% sorgt dafï¿½r, dass Bild bï¿½ndig mit Anfang der Caption
...
% Caption fï¿½r nicht-flieï¿½enden Figure Umgebung:
...
%So war es und so funktioniert es auch. Captions sind aber noch zu groï¿½
%\newcommand{\randbild}[5]   % Bild-Pfadname, Kurzbeschriftung (fï¿½r Abbildungsverzeichnis), Beschriftung, Breite zw. 0 und 1 = 100% des Randes, Label
%{%
%\marginpar%
	%{%
...
%% Das hier setzt die Caption vï¿½llig falsch mittenrein.
%\newcommand{\randbild}[5]   % Bild-Pfadname, Kurzbeschriftung (fï¿½r Abbildungsverzeichnis), Beschriftung, Breite zw. 0 und 1 = 100% des Randes, Label
%{%
%\marginnote{%
...
%\newcommand{\randcapbild}[5]  % Bild-Pfadname, Kurzbeschriftung (fï¿½r Abbildungsverzeichnis), Beschriftung, Breite zw. 0 und 1 = 100% des Randes, Label
%{%
%\begin{figure}
	%\begin{margincap}
		%\Centering
